...
# Installing Agent Based OpenShift 4.17 on VMware vSphere

## Table of contents

* [Agent Based OpenShift 4.17 on VMware vSphere](#agent-based-openshift-4.17-on-vmware-vsphere)

* [Prerequisites for Installing Agent Based OpenShift 4.17 on VMware vSphere](#prerequisites-for-installing-agent-based-openshift-4.17-on-vmware-vsphere)

* [Installing Agent Based OpenShift 4.17 on VMware vSphere](#installing-agent-based-openshift-4.17-on-vmware-vsphere)
...
## Agent Based OpenShift 4.17 on VMware vSphere

Cisco ACI supports Agent Based Red Hat OpenShift 4.17 on VMware vSphere. This document provides the instructions to provision OpenShift 4.17
on VMware vSphere with the Container Network Interface (CNI) plug-in.


## Prerequisites for Installing Agent Based OpenShift 4.17 on VMware vSphere

To install Agent Based OpenShift Container Platform (OCP) 4.17 on VMware vSphere, fulfill the following prerequisites:
...
Complete the tasks in the previous section: Prerequisites for Installing Agent Based OpenShift 4.17 on VMware vSphere .
...
This section contains sample files that you need for installing agent based OpenShift 4.17 on Vmware vSphere.
...
* Follow steps to create machineset as mentioned in the link: https://docs.openshift.com/container-platform/4.17/machine_management/creating_machinesets/creating-machineset-vsphere.html to scale the cluster.
