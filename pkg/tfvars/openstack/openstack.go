...
type AciNetExtStruct struct {
        InfraVLAN              string   `json:"apic:nested_domain_infra_vlan,omitempty"`
        NetworkVLAN            string   `json:"apic:nested_domain_node_network_vlan,omitempty"`
        ServiceVLAN            string   `json:"apic:nested_domain_service_vlan,omitempty"`
}
