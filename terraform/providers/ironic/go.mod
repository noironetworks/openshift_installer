...
require github.com/openshift-metal3/terraform-provider-ironic v0.3.0
...
require (
	...
	github.com/metal3-io/baremetal-operator v0.0.0-20220310151803-2b47127ed7ae // indirect
